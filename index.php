    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center">
          <h1 data-aos="fade-up">We Code your Dream to Reality</h1>
  ...
  <main id="main">
        ...
        <div class="row gx-0">
          ...
          <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
            <div class="content">
              ...
              <p>
               We are a team of experienced software engineers, developers, UX architects, designers and QA engineers working to produce impactful software.We are specialized in custom web applications, intuitive mobile apps, and robust data mining techniques, our team creates digital solutions that impact millions of lives. We have created hundreds of solutions over the last decade and helped businesses like yours expand at a rapid scale. We understand the challenges of working with a remote team and focus on providing an experience that feels like having a software development team next door. Bring your idea. Let us create it.
              </p>
              <div class="text-center text-lg-start">
    ...
    <section id="values" class="values">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <header class="section-header">
          <h2>Our Values</h2>
          <p>At Jadoon Technologies we love to build and refine technologies that improve lives while developing great relationships along the way</p>
        </header>
        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            <div class="box" data-aos="fade-up" data-aos-delay="200">
              ...
              <h3>Build enduring partnerships</h3>
              <p>We believe in nurturing long term relationships with our clients. You need a partner you can trust to not only bring your idea to life, but also to grow with.</p>
            </div>
          </div>
    ...
    <section id="services" class="services">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <header class="section-header">
          <h2>Services</h2>
          <p>We take care of all the technology so you can focus on what you do best</p>
        </header>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="500">
            <div class="service-box red">
              ...
              <p>We have highly skilled team of graphic designers</p>
              <a href="#" class="read-more"><span>Read More</span> <i class="bi bi-arrow-right"></i></a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="600">
            <div class="service-box purple">
              <i class="ri-discuss-line icon"></i>
              <h3>Ecommerce</h3>
              <p>We provide a number of ecommerce solutions ranging from creating brand identity to creation of fully functional online store</p>
              <a href="#" class="read-more"><span>Read More</span> <i class="bi bi-arrow-right"></i></a>
            </div>
          </div>
        ...
        <div class="row gy-4 portfolio-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="assets/img/portfolio/gjanab.jpg" class="img-fluid" alt="">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            <div class="portfolio-wrap">
              <img src="assets/img/portfolio/grandbachat.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Grand Bachat</h4>
                <p>Web</p>
                <div class="portfolio-links">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="assets/img/portfolio/dealmart.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Deal Mart</h4>
                <p>App</p>
                <div class="portfolio-links">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-wrap">
              <img src="assets/img/portfolio/green.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Green Garden</h4>
                <p>Logo</p>
                <div class="portfolio-links">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            <div class="portfolio-wrap">
              <img src="assets/img/portfolio/aussiechillout.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Aussie Chillout</h4>
                <p>Web</p>
                <div class="portfolio-links">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="assets/img/portfolio/smartmart.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Smart Mart</h4>
                <p>App</p>
                <div class="portfolio-links">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-wrap">
              <img src="assets/img/portfolio/jtwood.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>JT Wood Work</h4>
                <p>Logo</p>
                <div class="portfolio-links">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-wrap">
              <img src="assets/img/portfolio/deal.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Deal Mart Logo</h4>
                <p>Logo</p>
                <div class="portfolio-links">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            <div class="portfolio-wrap">
              <img src="assets/img/portfolio/citywide.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>City Wide DJ Services</h4>
                <p>Web</p>
                <div class="portfolio-links">
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <p>
                  Best Quality Professional Work.
                </p>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <p>
                  Very Professional Work! 100% Recommended
                </p>
                <div class="profile mt-auto">
                  <img src="assets/img/testimonials/testimonials-4.jpg" class="testimonial-img" alt="">
                  <h3>Ahsan</h3>
                  <h4>Ahsan Medical Store</h4>
                </div>
              </div>
            </div><!-- End testimonial item -->
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
            <div class="member">
              <div class="member-img">
                <img src="assets/img/team/omer.jpg" class="img-fluid" alt="">
                <div class="social">
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200">
            <div class="member">
              <div class="member-img">
                <img src="assets/img/team/mohsin.jpg" class="img-fluid" alt="">
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
                  <a href=""><i class="bi bi-instagram"></i></a>
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="300">
            <div class="member">
              <div class="member-img">
                <img src="assets/img/team/hamza.jpg" class="img-fluid" alt="">
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
                  <a href=""><i class="bi bi-instagram"></i></a>
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="400">
            <div class="member">
              <div class="member-img">
                <img src="assets/img/team/atif.jpg" class="img-fluid" alt="">
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
                  <a href=""><i class="bi bi-instagram"></i></a>
    ...
    <section id="clients" class="clients">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <header class="section-header">
          <h2>Our Clients</h2>
          <p>We have empowered alot of businesses with our high quality products</p>
        </header>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-12 text-center">
            ...
            <p>Subscribe to our newsletter to stay updated with our new updates</p>
          </div>
          <div class="col-lg-6">
      ...
      <div class="container">
        <div class="row gy-4">
          ...
          <div class="col-lg-3 col-md-12 footer-contact text-center text-md-start">
            <h4>Contact Us</h4>
            <p>
              Opposite Daewoo Adda <br>
              Haripur, KPK 22620<br>
              Pakistan <br><br>
              <strong>Phone:</strong> +92 335 9119460<br>
              <strong>Email:</strong> info@jadoontechnologies.com<br>
            </p>
